...
describe('FriendId', () => {
    ...
    describe('create', () => {
        ...
        it('빈 문자열은 에러를 던진다', () => {
            // When & Then
            expect(() => FriendId.create('')).toThrow(Error);
        });
        ...
        it('잘못된 UUID 형식은 에러를 던진다', () => {
            // When & Then
            expect(() => FriendId.create('invalid-uuid')).toThrow(Error);
            expect(() => FriendId.create('123456')).toThrow(Error);
        });
        ...
        it('UUID v1 형식은 에러를 던진다', () => {
            ...
            // When & Then
            expect(() => FriendId.create(uuidV1)).toThrow(Error);
        });
    });
