...
describe('UpdateTagPositionUseCase', () => {
    let useCase: UpdateTagPositionUseCase;
    ...
    beforeEach(() => {
        ...
        useCase = new UpdateTagPositionUseCase(mockStrategyCommandRepository);
    });
    ...
    describe('성공 테스트', () => {
        it('Command를 생성하여 Repository에 전달한다.', async () => {
            ...
            // then
            expect(
                mockStrategyCommandRepository.updateTagPosition
