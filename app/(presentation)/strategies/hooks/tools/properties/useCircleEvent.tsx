...
import { useCreateCircleMutation } from '@/(presentation)/strategies/hooks/mutations/create/useCreateCircleMutation';
import { useUpdateCirclePositionMutation } from '@/(presentation)/strategies/hooks/mutations/update/useUpdateCirclePositionMutation';
import { CircleResponseDto } from '@/application/strategy/dto/strategy/get-strategy.dto';
import { useDeleteCircleMutation } from '@/(presentation)/strategies/hooks/mutations/delete/useDeleteCircleMutation';
import PhaseSelectModal from '@/(presentation)/strategies/modals/[id]/phase-select.modal';
import { PropertyClickPayload } from '@/(presentation)/strategies/components/[id]/body/strategy-body.component';
import CirclesLayer from '@/(presentation)/strategies/components/[id]/tools/properties/circle-property.component';
