...
import { useCreateAirplanePathMutation } from '@/(presentation)/strategies/hooks/mutations/create/useCreateAirplanePathMutation';
import { useUpdateAirplanePathMutation } from '@/(presentation)/strategies/hooks/mutations/update/useUpdateAirplanePathMutation';
import { AirplanePathResponseDto } from '@/application/strategy/dto/strategy/get-strategy.dto';
import { useDeleteAirplanePathMutation } from '@/(presentation)/strategies/hooks/mutations/delete/useDeleteAirplanePathMutation';
import { PropertyClickPayload } from '@/(presentation)/strategies/components/[id]/body/strategy-body.component';
import AirplanePathLayer from '@/(presentation)/strategies/components/[id]/tools/properties/airplane-path-property.component';
