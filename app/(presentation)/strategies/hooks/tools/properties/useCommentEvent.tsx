import { useCreateParentCommentMutation } from '@/(presentation)/strategies/hooks/mutations/create/useCreateParentCommentMutation';
import React, { useState } from 'react';
import { CommentResponseDto } from '@/application/strategy/dto/strategy/get-strategy.dto';
import { useUpdateCommentContentMutation } from '@/(presentation)/strategies/hooks/mutations/update/useUpdateCommentContentMutation';
import { useDeleteCommentMutation } from '@/(presentation)/strategies/hooks/mutations/delete/useDeleteCommentMutation';
import StrategyCommentWindow from '@/(presentation)/strategies/modals/[id]/strategy-comment-window.modal';
import CommentsLayer from '@/(presentation)/strategies/components/[id]/tools/properties/comment-property.component';
import { useCreateChildCommentMutation } from '@/(presentation)/strategies/hooks/mutations/create/useCreateChildCommentMutation';
import { useUpdateCommentPositionMutation } from '@/(presentation)/strategies/hooks/mutations/update/useUpdateCommentPositionMutation';
