import { useCreateTagMutation } from '@/(presentation)/strategies/hooks/mutations/create/useCreateTagMutation';
import React, { useState } from 'react';
import { TagResponseDto } from '@/application/strategy/dto/strategy/get-strategy.dto';
import { useDeleteTagMutation } from '@/(presentation)/strategies/hooks/mutations/delete/useDeleteTagMutation';
import EnterTagContentModal from '@/(presentation)/strategies/modals/[id]/enter-tag-content.modal';
import { PropertyClickPayload } from '@/(presentation)/strategies/components/[id]/body/strategy-body.component';
import TagsLayer from '@/(presentation)/strategies/components/[id]/tools/properties/tag-property.component';
import { useUpdateTagPositionMutation } from '@/(presentation)/strategies/hooks/mutations/update/useUpdateTagPositionMutation';
