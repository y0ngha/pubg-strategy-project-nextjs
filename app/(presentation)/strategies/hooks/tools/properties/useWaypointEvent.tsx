import { useCreateWaypointMutation } from '@/(presentation)/strategies/hooks/mutations/create/useCreateWaypointMutation';
import { toast } from 'react-toastify';
import { useUpdateWaypointPositionsMutation } from '@/(presentation)/strategies/hooks/mutations/update/useUpdateWaypointPositionsMutation';
import { TeamPlayerResponseDto } from '@/application/strategy/dto/strategy/get-strategy.dto';
import { Fragment, useEffect, useEffectEvent, useState } from 'react';
import { useDeleteWaypointMutation } from '@/(presentation)/strategies/hooks/mutations/delete/useDeleteWaypointMutation';
import { PropertyClickPayload } from '@/(presentation)/strategies/components/[id]/body/strategy-body.component';
import WaypointProperty from '@/(presentation)/strategies/components/[id]/tools/properties/waypoint-property.component';
