import { useCreateMarkerMutation } from '@/(presentation)/strategies/hooks/mutations/create/useCreateMarkerMutation';
import { toast } from 'react-toastify';
import { useUpdateMarkerPositionMutation } from '@/(presentation)/strategies/hooks/mutations/update/useUpdateMarkerPositionMutation';
import { TeamPlayerResponseDto } from '@/application/strategy/dto/strategy/get-strategy.dto';
import { useDeleteMarkerMutation } from '@/(presentation)/strategies/hooks/mutations/delete/useDeleteMarkerMutation';
import { Fragment, useState } from 'react';
import { PropertyClickPayload } from '@/(presentation)/strategies/components/[id]/body/strategy-body.component';
import MarkerProperty from '@/(presentation)/strategies/components/[id]/tools/properties/marker-property.component';
