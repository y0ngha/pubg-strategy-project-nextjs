import { CanvasTool } from '@/(presentation)/strategies/hooks/tools/useToolbar';
import { useCircleEvent } from '@/(presentation)/strategies/hooks/tools/properties/useCircleEvent';
import { useAirplanePathEvent } from '@/(presentation)/strategies/hooks/tools/properties/useAirplanePathEvent';
import { useEnemyTeamEvent } from '@/(presentation)/strategies/hooks/tools/properties/useEnemyTeamEvent';
import { useTeamPlayerEvent } from '@/(presentation)/strategies/hooks/tools/properties/useTeamPlayerEvent';
import { useTagEvent } from '@/(presentation)/strategies/hooks/tools/properties/useTagEvent';
import { useMarkerEvent } from '@/(presentation)/strategies/hooks/tools/properties/useMarkerEvent';
import { useWaypointEvent } from '@/(presentation)/strategies/hooks/tools/properties/useWaypointEvent';
import { useCommentEvent } from '@/(presentation)/strategies/hooks/tools/properties/useCommentEvent';
import {
