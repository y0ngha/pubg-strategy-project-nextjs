...
import StrategyToolButton from '@/(presentation)/strategies/components/[id]/tools/strategy-tool-button.component';
import StrategyToolDivider from '@/(presentation)/strategies/components/[id]/tools/strategy-tool-divider.component';
