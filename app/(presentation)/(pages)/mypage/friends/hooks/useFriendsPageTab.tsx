...
import FriendsPageTab from '@/(presentation)/(pages)/mypage/friends/components/friends-page-tab.component';
import FriendsPageTabContent from '@/(presentation)/(pages)/mypage/friends/components/friends-page-tab-content.component';
